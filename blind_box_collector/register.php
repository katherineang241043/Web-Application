    ...
    <div class="simple-auth-card">
        ...
        <form method="POST" action="register.php" class="two-column-form" autocomplete="off">
            <div class="form-group">
                ...
                <input id="full_name" type="text" name="full_name" value="" autocomplete="off" required>
            </div>

            <div class="form-group">
                <label for="email">Email Address</label>
                <input id="email" type="email" name="email" value="" autocomplete="off" required>
            </div>

            <div class="form-group">
                <label for="phone">Phone Number</label>
                <input id="phone" type="tel" name="phone" value="" inputmode="numeric" pattern="[0-9]+" title="Please enter numbers only." autocomplete="off" required>
            </div>

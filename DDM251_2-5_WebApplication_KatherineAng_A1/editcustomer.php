...
if (isset($_POST['username'])) {
    ...
    if ($pword === $cpword) {
        $sql = "UPDATE customers SET 
                UserName='$uname', Password='$pword', Name='$name', Email='$email', PhoneNumber='$phone' 
...
$customer_id = $_POST['CustomerID'] ?? $_GET['CustomerID'] ?? '';

if (!empty($customer_id)) {
    $res = mysqli_query($conn, "SELECT * FROM customers WHERE CustomerID = '$customer_id'");
...
<body>
            ...
            <div class="form-container">
                <form method="POST" onsubmit="return validatePassword()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" value="<?php echo $row['UserName']; ?>" required autocomplete="off">
                    </div>

                    <div class="form-group">
                        <label>Password:</label>
                        <div style="position: relative; width: 75%; padding: 0; margin: 0;">
                            <input type="password" id="pword" name="password" value="<?php echo $row['Password']; ?>" required autocomplete="off" style="width: 100%; padding-right: 35px;">
                    ...
                    <div class="form-group">
                        ...
                        <div style="position: relative; width: 75%; padding: 0; margin: 0;">
                            <input type="password" id="cpword" name="confirmpassword" value="<?php echo $row['Password']; ?>" required autocomplete="off" style="width: 100%; padding-right: 35px;">
                            <i class="fa-regular fa-eye" onclick="toggleVisibility('cpword', this)" style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #4B2E2B;"></i>
                        </div>
                    </div>

                    <div class="form-group">
                        <label>Name:</label>
                        <input type="text" name="name" value="<?php echo $row['Name']; ?>" required autocomplete="off">
                    </div>

                    <div class="form-group">
                        <label>Email:</label>
                        <input type="email" name="email" value="<?php echo $row['Email']; ?>" required autocomplete="off">
                    </div>

                    <div class="form-group">
                        <label>Phone Number:</label>
                        <input type="text" name="phonenumber" value="<?php echo $row['PhoneNumber']; ?>" required autocomplete="off">
                    </div>
    ...
    <script>
        function validatePassword() {
            ...
            var p2 = document.getElementById("cpword").value;
            if (p1 !== p2) {

...
$id_res = mysqli_query($conn, "SELECT MAX(CAST(ProductID AS UNSIGNED)) AS max_id FROM products");
$id_row = mysqli_fetch_assoc($id_res);
$auto_product_id = ($id_row['max_id']) ? $id_row['max_id'] + 1 : 1001;
...
if (isset($_POST['productName'])) {
    ...
    $sql = "INSERT INTO products (ProductID, ProductName, Price, Quantity) 
            VALUES ('$auto_product_id', '$pname', '$price', '$qty')";
            ...
            <div class="form-container">
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="productID" value="<?php echo $auto_product_id; ?>" readonly>
                    </div>
                    ...
                    <div class="button-group">
                        ...
                        <input type="submit" class="btn btn-submit" value="Add Product">
                    </div>
